...
# MAGIC %md
# MAGIC # Databricks Serverless SQL Accelerator
# MAGIC A quick start solution to use Databricks Serverless SQL
# MAGIC * Suggesting optimization techniques
# MAGIC * Benchmark performance using tpch, tpcds, or bring your own data
# MAGIC * Automating data generation for bring your own data
# MAGIC
# MAGIC ## Notes
# MAGIC * Only work with SQL Serverless enabled workspace  
...
beaker = Benchmark(**benchmark_configs)
